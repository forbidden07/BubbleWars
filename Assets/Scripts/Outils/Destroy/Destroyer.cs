...
namespace Nalka.Tools.Unity
{
    ...
    public static class Destroyer
    {
        ...
        public async static void Destroy<DestroyedT>(DestroyedT DestroyedObject, int delay, [CallerFilePath] string destroyerPath = "") where DestroyedT : Object
        {
            await Task.Delay(delay);
            Destroy(DestroyedObject, destroyerPath);
        }
